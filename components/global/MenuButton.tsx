...
const MenuButton = ({ text, smallScreens, id, ...args }: MenuBtnProps) => {
	...
	return (
		<button
			...
			${
				smallScreens
					? 'md:hidden relative my-[40px]'
					: 'hidden md:inline fixed top-8 right-10 z-[1000]'
			}`}
			{...args}
		>
			...
			<span
				className='hidden sm:inline text-[#e8e8e8] group-hover/menu-btn:text-black capitalize
