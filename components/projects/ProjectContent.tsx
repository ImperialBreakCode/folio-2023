	...
	return (
		<div className='p-4 bg-[#171717]'>
			<div className='flex items-center justify-center w-full my-4 sm:my-10'>
				<Image className='sm:max-w-[95%] lg:max-w-[80%]' src={imgSrc} alt={alt} />
			</div>
	...
	return (
		<div className='flex flex-col sm:flex-row justify-center p-2 sm:p-10 md:mt-28 mb-10 2xl:my-32'>
			<div className='sm:w-1/3 md:text-lg text-center sm:text-end sm:pe-10 lg:pe-20'>
				<h3 className='text-lg md:text-xl uppercase sm:mb-3'>Details</h3>
			...
			<div className='sm:w-2/3 md:pe-20 lg:pe-40 xl:pe-80 mt-6 sm:mt-0'>
				<p className='text-lg sm:text-xl lg:text-2xl font-light text-[#e0e0e0]'>{children}</p>
			</div>
		</div>
	);
};
...
export const ProjectSection = ({
	...
	return (
		<div className='flex flex-col md:flex-row justify-center items-center lg:px-10 xl:px-20'>
			<div className='md:w-1/2 sm:px-10'>
				...
				<p className='md:text-lg xl:text-xl mt-4 font-extralight'>{children}</p>
			</div>
