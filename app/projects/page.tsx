							...
							<div className='flex flex-row justify-center p-10 my-32'>
								...
								<div className='w-2/3 pe-80'>
									<p className='text-2xl font-light text-[#e0e0e0]'>
										Mauris cursus venenatis enim vel
										pretium. Praesent placerat justo nec
										turpis iaculis eleifend. Nullam euismod
										laoreet velit, non dictum dolor
										convallis nec. Praesent lacus dolor,
										convallis eu scelerisque ac, congue sed
										metus.Mauris cursus venenatis enim vel
										pretium. Praesent placerat justo nec
										turpis iaculis eleifend. Nullam euismod
										laoreet velit, non dictum dolor
										convallis nec. Praesent lacus dolor,
							...
							<div className='flex flex-row justify-center items-center px-20'>
                                <div className='w-1/2 px-10'>
                                    ...
                                    <p className='text-xl mt-4 font-extralight'>
                                        ...
                                        dolor, convallis eu scelerisque ac, congue
                                        sed metus.
                                    </p>
                                </div>
